...
//@todo decide what we are going to show here.
 ...
 * @access public
 */
class View_Rt_Members extends View {
	...
	public function section_roles_caps() { ?>
		...
		<p class="description">
			<?php esc_html_e( 'xxxxxYour roles and capabilities will not revert back to their previous settings after deactivating or uninstalling this plugin, so use this feature wisely.', 'members' ); ?>
		</p>
	<?php }
	...
	public function welcome_info(){
		?>
		<h3><?php esc_html_e("Restrict Taxonomy Add-on for Members","rt-members");?></h3>
		<p><?php _e("This Add-On extends Members Plugin by restrictable taxonomies. For example users can now be locked out from restricted categories.","rt-members"); // @todo add welcome html here?></p>
		<?php
	}
